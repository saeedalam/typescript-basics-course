...
// const userA: GenericType<number, string> = {
//   id: 10000,
//   name: "saeedd",
// };

// const userB: GenericType<string, string> = {
//   id: "IR39738758",
//   name: "saeeda",
// };
// console.log(userA);
...
// function showType(args: Partial<StudentType>) {
//   console.log(args);
// }

// const student: Partial<StudentType> = {
//   firstName: "Adrian",
//   lastName: "Valipour Alam",
// };

// showType({ id: 1 , firstName:"Adrian" });
// // Output: {id: 1}
...
// function showType(args: Readonly<StudentType>) {
//   args.id = 4
//   console.log(args)
// }
...
// function showType(args: Pick<StudentType, "firstName" | "lastName">) {
//   console.log(args);
// }
...
// type ValidTypes = string | number | null | undefined;
// let u1 : ValidTypes = "Alex"
// let u2 : ValidTypes = null

// function printUser(args: NonNullable<ValidTypes>) {
//   console.log(args);
// }
...
// function strUserPrinter(arg: MyStringMap<User>) {
//   console.log(arg);
// }
...
// strUserPrinter({ id: "testId", name: "This is a Test" });
...
// // all fields should be in string
// function Printer(arg: MyPartial<User>) {
//   console.log(arg);
// }

// const u: User = { id: 1, name: "sds" };
// Printer({});
