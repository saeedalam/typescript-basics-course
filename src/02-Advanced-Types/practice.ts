...
// showTypes({id:1 , right:"Hello Right" , left:"Hello Left"})
...
// function genFunc<T>(arg : T){
//   console.log(arg)
// }
// [1,true,"SAEED"].forEach(genFunc)
...
//   name: string
// }
// const userA :IUser<number> = { id : 1000 , name:"SAEED"}
// const userB :IUser<string> = {id:"23hf-djhskf23-2jh3" , name:"Adrian"}
// const userPrinter = (user:IUser<string | number>) => console.log(user)
// userPrinter(userA)
// userPrinter(userB)
